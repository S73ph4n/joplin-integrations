...
ENV = {"JOPLIN_TOKEN": "", "JOPLIN_HOST":"localhost", "JOPLIN_PORT":"41184", "ZOTERO_LIBRARY_ID": "", "ZOTERO_API_KEY": "", "ZOTERO_COLLECTION_ID":"", "NOTES_TAG":"zotero", "WAIT_TIME":"60"}
    ...
    try:
        ...
        for item in items:
            if not CONFIRM or click.confirm(
                ...
                if note.body != '': click.echo("Note exists. Updating...")
